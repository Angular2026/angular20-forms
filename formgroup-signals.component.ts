...
ctrMock.setFullModelProbabilityOfDefault(BigDecimal.valueOf(2.69));
ctrMock.setFullModelRating("7");
ctrMock.setFullModelRatingDate(LocalDate.parse("2026-06-01"));
...
mock.setCrfRatingResults(ctrMock);  // ← crf pas ctr
